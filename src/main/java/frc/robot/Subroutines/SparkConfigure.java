...
public class SparkConfigure {
    ...
    public static void ElevatorInit(SparkMax m_elevatorLeft, SparkMax m_elevatorRight)
    {
        SparkMaxConfig globalElevatorLeaderConfig = new SparkMaxConfig();
        SparkMaxConfig rightFollowerElevatorConfig = new SparkMaxConfig();
            ...
            rightFollowerElevatorConfig
                .apply(globalElevatorLeaderConfig)
