...
//     SparkMax m_pickupLeft = new SparkMax((deviceId: x), MotorType.kBrushless); //states the existance of a sparkmax with a CANid of 9
//     SparkMax m_pickupRight = new SparkMax((deviceId: y), MotorType.kBrushless); //states the existance of a sparkmax with a CANid of 9

//     SparkMax[] CANIDs= {m_pickupLeft, m_pickupRight};

//     RelativeEncoder p_Encoder = m_pickupLeft.getEncoder();


//     public void Initial (){
//         SparkConfigure.pickupInit(m_pickupLeft, m_pickupRight);
//     }
...
//         m_pickupLeft.set(speed*speedPercentage);
//     }
